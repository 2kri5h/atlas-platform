        ...
        <div className="google-modal-header">
          <div className="google-modal-title-wrap">
            <div className="google-icon-badge">
              <Globe size={22} className="google-color-icon" />
            </div>
            <div>
